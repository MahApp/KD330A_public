...
public class Journey {
	...
	public String toString() {
		...
		sb.append("Departure: " + sdf.format(depDateTime.getTime())).append("\n");
		sb.append("Arrival: " + sdf.format(arrDateTime.getTime())).append("\n");
		sb.append("Type: " + lineOnFirstJourney.toString()).append("\n");
		sb.append("Changes: " + noOfChanges.toString()).append("\n");
		sb.append("Duration: " + travelMinutes.toString()).append("\n");
